...
(async () => {
    ...
    try {
        ...
        // Go to home first
        await page.goto('https://www.civitatis.com/ar/', { waitUntil: 'domcontentloaded' });
        ...
        await page.goto('https://www.civitatis.com/ar/cordoba-argentina/?currency=ARS', { waitUntil: 'domcontentloaded' });
        ...
        console.log("With ?currency=ARS and cookies:");
